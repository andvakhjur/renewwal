...
class Admin_Model_BannersCategoriesModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'banners_categories';
    ...
    {
        $this->_table = new Admin_Model_DbTable_BannersCategoriesDbTable();
    }
