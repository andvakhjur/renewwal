...
class Admin_Model_CatalogSizesModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'catalog_sizes';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CatalogSizesDbTable();
    }
    ...
    {
        return new Admin_Form_CatalogSizesForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CatalogSizesFilter($options);
    }
}