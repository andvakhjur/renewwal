...
class Admin_Model_CatalogCategoriesModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'catalog_categories';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Категории';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CatalogCategoriesDbTable();
    }
    ...
    {
        return new Admin_Form_CatalogCategoriesForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CatalogCategoriesFilter($options);
    }
}