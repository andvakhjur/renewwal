...
class Admin_Model_NewsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'news';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Новости';
    ...
    {
        $this->_table = new Admin_Model_DbTable_NewsDbTable();
    }
    ...
    {
        return new Admin_Form_NewsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_NewsFilter($options);
    }
}