...
class Admin_Model_CartOrdersProductsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'cart_orders_products';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CartOrdersProductsDbTable();
    }
    ...
    {
        return new Admin_Form_CartOrdersProductsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CartOrdersProductsFilter($options);
    }
}