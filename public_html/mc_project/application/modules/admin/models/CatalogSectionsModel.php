...
class Admin_Model_CatalogSectionsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'catalog_sections';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Разделы';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CatalogSectionsDbTable();
    }
