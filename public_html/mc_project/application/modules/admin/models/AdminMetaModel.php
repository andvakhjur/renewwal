...
class Admin_Model_AdminMetaModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'admin_meta';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Мета';
    ...
    {
        $this->_table = new Admin_Model_DbTable_AdminMetaDbTable();
    }
    ...
    {
        return new Admin_Form_AdminMetaForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_AdminMetaFilter($options);
    }
}