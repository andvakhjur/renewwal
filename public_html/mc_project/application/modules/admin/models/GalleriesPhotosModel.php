...
class Admin_Model_GalleriesPhotosModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'galleries_photos';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Фото';
    ...
    {
        $this->_table = new Admin_Model_DbTable_GalleriesPhotosDbTable();
    }
    ...
    {
        return new Admin_Form_GalleriesPhotosForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_GalleriesPhotosFilter($options);
    }
}