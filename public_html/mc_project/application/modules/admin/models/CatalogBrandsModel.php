...
class Admin_Model_CatalogBrandsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'catalog_brands';

    /**
     * Лэйбл крошки в breadcrumbs
     */
    const crumbLabel = 'Бренды';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CatalogBrandsDbTable();
    }
    ...
    {
        return new Admin_Form_CatalogBrandsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CatalogBrandsFilter($options);
    }
}