...
class Admin_Model_AdminEmailsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'admin_emails';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'E-mail адреса';
    ...
    {
        $this->_table = new Admin_Model_DbTable_AdminEmailsDbTable();
    }
    ...
    {
        return new Admin_Form_AdminEmailsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_AdminEmailsFilter($options);
    }
}