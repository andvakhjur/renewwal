...
class Admin_Model_StructureModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'structure';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Структура';
    ...
    {
        $this->_table = new Admin_Model_DbTable_StructureDbTable();
    }
