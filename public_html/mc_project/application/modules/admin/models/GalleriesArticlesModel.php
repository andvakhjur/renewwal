...
class Admin_Model_GalleriesArticlesModel extends Mc_Model
{
    /**
    ...
    {
        $this->_table = new Admin_Model_DbTable_GalleriesArticlesDbTable();
    }
    ...
    {
        return new Admin_Form_GalleriesArticlesForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_GalleriesArticlesFilter($options);
    }
}