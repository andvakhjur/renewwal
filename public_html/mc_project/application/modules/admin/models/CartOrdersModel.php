...
class Admin_Model_CartOrdersModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'cart_orders';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Заказы';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CartOrdersDbTable();
    }
    ...
    {
        return new Admin_Form_CartOrdersForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CartOrdersFilter($options);
    }
}