...
class Admin_Model_AdminStaticModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'admin_static';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Статика';
    ...
    {
        $this->_table = new Admin_Model_DbTable_AdminStaticDbTable();
    }
    ...
    {
        return new Admin_Form_AdminStaticStandartForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_AdminStaticFilter($options);
    }
}