...
class Admin_Model_CatalogProductsPhotosModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'catalog_products_photos';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Фотки';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CatalogProductsPhotosDbTable();
    }
    ...
    {
        return new Admin_Form_CatalogProductsPhotosForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CatalogProductsPhotosFilter($options);
    }
}