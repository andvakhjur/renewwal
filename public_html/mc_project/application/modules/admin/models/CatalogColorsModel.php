...
class Admin_Model_CatalogColorsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'catalog_colors';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CatalogColorsDbTable();
    }
    ...
    {
        return new Admin_Form_CatalogColorsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CatalogColorsFilter($options);
    }
}