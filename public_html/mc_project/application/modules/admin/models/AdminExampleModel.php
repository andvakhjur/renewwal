...
class Admin_Model_AdminExampleModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'admin_example';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Example';
    ...
    {
        $this->_table = new Admin_Model_DbTable_AdminExampleDbTable();
    }
    ...
    {
        return new Admin_Form_AdminExampleForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_AdminExampleFilter($options);
    }
}