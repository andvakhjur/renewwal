...
class Admin_Model_CartDiscountsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'cart_discounts';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Скидки';
    ...
    {
        $this->_table = new Admin_Model_DbTable_CartDiscountsDbTable();
    }
    ...
    {
        return new Admin_Form_CartDiscountsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_CartDiscountsFilter($options);
    }
}