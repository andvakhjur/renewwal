...
class Admin_Model_MainGalleriesPhotosModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'main_galleries_photos';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Галерея на главной';
    ...
    {
        $this->_table = new Admin_Model_DbTable_MainGalleriesPhotosDbTable();
    }
    ...
    {
        return new Admin_Form_MainGalleriesPhotosForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_MainGalleriesPhotosFilter($options);
    }
}