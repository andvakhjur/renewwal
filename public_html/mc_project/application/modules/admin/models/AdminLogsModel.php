...
class Admin_Model_AdminLogsModel extends Mc_Model
{
    /**
     * Папка для сохранения файлов
     */
    const uploadDir = 'admin_logs';
    
    /**
     * Лэйбл крошки в breadcrumbs 
     */
    const crumbLabel = 'Журнал';
    ...
    {
        $this->_table = new Admin_Model_DbTable_AdminLogsDbTable();
    }
    ...
    {
        return new Admin_Form_AdminLogsForm($options);
    }

    public function getFormFilter($options = null)
    {
        return new Admin_Form_Filter_AdminLogsFilter($options);
    }
}