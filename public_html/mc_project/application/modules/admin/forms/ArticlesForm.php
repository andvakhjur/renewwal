...
class Admin_Form_ArticlesForm extends Mc_Form {
    ...
    public function init() {
        ...
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Время публикации') . ': ');
        //--------------------------------------------------------------------//
        $elementName = 'show';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Select($elementName);
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Показывать') . ': ');
        ...
        $this->groups[$groupName][$elementName]->addMultiOptions(array(
            'show' => Zend_Registry::get('view')->translate('да'),
            'hide' => Zend_Registry::get('view')->translate('нет'),
            'mod'  => Zend_Registry::get('view')->translate('на модерации'),
            'del'  => Zend_Registry::get('view')->translate('удалено'),
        ));
        //####################################################################//
        ...
        //--------------------------------------------------------------------//
        $elementName = 'img';
        $articlesModel = new Admin_Model_ArticlesModel();
        ...
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Картинка') . ': ');
        //--------------------------------------------------------------------//
...
//                ),
        ...
        $this->groups[$groupName][$elementName] = new Mc_Form_Element_ImageUpload($elementName, $this->_options[$elementName], $this);
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Картинка (превью)') . ': ');
//        //--------------------------------------------------------------------//
//        $elementName = 'file';
//        $articlesModel = new Admin_Model_ArticlesModel();
//        // получаем данные из таблицы
...
//        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Файл') . ': ');
        //####################################################################//
        ...
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Название') . ': ');
        //$this->groups[$groupName][$elementName]->setRequired(true);
        ...
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Текст') . ': ');
        //$this->groups[$groupName][$elementName]->setRequired (true);
        ...
        $elementName = 'stxt';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Textarea($elementName);
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('Краткий текст') . ': ');
        //$this->groups[$groupName][$elementName]->setRequired (true);
        $this->groups[$groupName][$elementName]->setAttrib('cols', 40);
        $this->groups[$groupName][$elementName]->setAttrib('rows', 4);
        $this->groups[$groupName][$elementName]->addDecorator('Tinymce', array(
        ...
        <a class="not_open_link" href="javascript: void(0);" onClick="javascript: seoToggle();">
            <?php echo Zend_Registry::get('view')->translate('Дополнительно'); ?>
        </a>
        ...
        $elementName = 'url';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Text($elementName);
        $this->groups[$groupName][$elementName]->setLabel(Zend_Registry::get('view')->translate('URL страницы') . ': ');
        //$this->groups[$groupName][$elementName]->setRequired(true);
        $this->groups[$groupName][$elementName]->addValidator(new Mc_Validate_ArticleExists(array(
            'modelName' => 'Admin_Model_ArticlesModel',
            'colName' => $elementName,
        ...
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Submit($elementName, array(
                'label' => Zend_Registry::get('view')->translate('Сохранить'),
                'class' => 'save_but'
            ));
        ...
        $elementName = 'cancel';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Submit($elementName, array(
                'label' => Zend_Registry::get('view')->translate('Отменить'),
                'class' => 'cancel_but'
            ));
        $this->groups[$groupName][$elementName]->clearDecorators();
        $this->groups[$groupName][$elementName]->addDecorator('ViewHelper');
    ...
    public function mapForm() {
        ...
        if(empty($return['url']) && $this->getElement('url')) {
            $catalogSections = new Admin_Model_ArticlesModel();
