...
class Admin_Form_AdminMetaForm extends Mc_Form
{
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->setLabel('Подсказка: ');
        ...
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Text($elementName);
        $this->groups[$groupName][$elementName]->setLabel('meta_title (title): ');
        //$this->groups[$groupName][$elementName]->setRequired(true);
        $this->groups[$groupName][$elementName]->setAttrib('size', 40);
        $this->groups[$groupName][$elementName]->setAttrib('style', 'width:387px');
        //--------------------------------------------------------------------//
