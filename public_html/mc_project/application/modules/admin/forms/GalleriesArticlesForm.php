...
class Admin_Form_GalleriesArticlesForm extends Mc_Form
{
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->addValidator(new Mc_Validate_ArticleExists(array(
            'modelName' => 'Admin_Model_GalleriesArticlesModel',
            'colName' => $elementName,
    ...
    public function mapForm()
    {
        ...
        if(empty($return['url']) && $this->getElement('url')) {
            $catalogSections = new Admin_Model_GalleriesArticlesModel();
