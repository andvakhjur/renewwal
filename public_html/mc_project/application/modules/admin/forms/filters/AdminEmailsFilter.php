...
class Admin_Form_Filter_AdminEmailsFilter extends Mc_Form_Filter
{
    public $groups = array();
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>Тип:</dt><dd>'));
        ...
        $this->groups[$groupName][$elementName]->setAttrib('id', 'filter_' . $this->groups[$groupName][$elementName]->getName());
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>Использовать:</dt><dd>'));
        //$this->groups[$groupName][$elementName]->setRequired(true);
