...
class Admin_Form_Filter_CartOrdersProductsFilter extends Mc_Form_Filter
{
    public $groups = array();
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>Заказ:</dt><dd>'));
        ...
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Select($elementName);
        $this->groups[$groupName][$elementName]->setAttrib('id', 'filter_' . $this->groups[$groupName][$elementName]->getName());
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>Товар:</dt><dd>'));
        $this->groups[$groupName][$elementName]->setAttrib('style', 'width:150px;');
        $options = array();
        $options[''] = 'все';
