...
class Admin_Form_Filter_BannersArticlesFilter extends Mc_Form_Filter
{
    public $groups = array();
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>Место:</dt><dd>'));
