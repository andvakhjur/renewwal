...
class Admin_Form_Filter_ArticlesFilter extends Mc_Form_Filter
{
    public $groups = array();
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>' . Zend_Registry::get('view')->translate('Дата c') . ':</dt><dd>'));
        //--------------------------------------------------------------------//
        $elementName = 'date_to';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Text($elementName);
        $this->groups[$groupName][$elementName]->setAttrib('id', 'filter_' . $this->groups[$groupName][$elementName]->getName());
        ...
        $this->groups[$groupName][$elementName]->addDecorator('Datepicker');
        $this->groups[$groupName][$elementName]->addDecorator('Errors');
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>' . Zend_Registry::get('view')->translate('Дата по'). ':</dt><dd>'));
        //--------------------------------------------------------------------//
        $elementName = 'show';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Select($elementName);
        $this->groups[$groupName][$elementName]->setAttrib('id', 'filter_' . $this->groups[$groupName][$elementName]->getName());
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>' . Zend_Registry::get('view')->translate('Показывать') . ':</dt><dd>'));
        ...
        $this->groups[$groupName][$elementName]->addMultiOptions(array(
            ''     => Zend_Registry::get('view')->translate('все'),
        ...
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Text($elementName);
        $this->groups[$groupName][$elementName]->setAttrib('id', 'filter_' . $this->groups[$groupName][$elementName]->getName());
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>' . Zend_Registry::get('view')->translate('Название') . ':</dt><dd>'));
        //$this->groups[$groupName][$elementName]->setRequired(true);
        //--------------------------------------------------------------------//
        $elementName = 'txt';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Text($elementName);
        $this->groups[$groupName][$elementName]->setAttrib('id', 'filter_' . $this->groups[$groupName][$elementName]->getName());
        $this->groups[$groupName][$elementName]->addDecorator('Labelsid', array('before' => '<dt>' . Zend_Registry::get('view')->translate('Текст') . ':</dt><dd>'));
        //$this->groups[$groupName][$elementName]->setRequired(true);
        //--------------------------------------------------------------------//
        $elementName = 'filter_submit';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Submit($elementName, array(
            'label' => Zend_Registry::get('view')->translate('Найти'),
            //'class' => 'save_but',
