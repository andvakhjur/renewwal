...
class Admin_Form_BannersArticlesForm extends Mc_Form
{
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->setLabel('Место: ');
        //$this->groups[$groupName][$elementName]->setRequired (true);
        $options = array();
        $options[''] = 'не выбрано';
        $opt = new Admin_Model_BannersCategoriesModel();
        $opt = $opt->getArticles();
        if (count($opt) > 0) {
        ...
        //$this->_groups[$groupName][$elementName]->setRequired(true);
        //$this->_groups[$groupName][$elementName]->setAttrib('size', 40);
        ...
        $elementName = 'link';
        $this->groups[$groupName][$elementName] = new Zend_Form_Element_Text($elementName);
        $this->groups[$groupName][$elementName]->setLabel('Ссылка: ');
        //$this->groups[$groupName][$elementName]->setRequired(true);
        $this->groups[$groupName][$elementName]->setAttrib('size', 40);
        //####################################################################//
        ...
        //--------------------------------------------------------------------//
        $elementName = 'img';
        $articlesModel = new Admin_Model_BannersArticlesModel();
        ...
        $this->groups[$groupName][$elementName]->setLabel('SWF-файл: ');
        //####################################################################//
...
//        if(empty($return['url'])) {
//            $catalogCategories = new Admin_Model_BannersArticlesModel();
