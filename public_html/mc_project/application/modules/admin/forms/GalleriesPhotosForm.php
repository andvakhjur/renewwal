...
class Admin_Form_GalleriesPhotosForm extends Mc_Form
{
    ...
    public function init()
    {
        ...
        $this->groups[$groupName][$elementName]->setLabel('Галерея: ');
        ...
        //--------------------------------------------------------------------//
        $elementName = 'img';
        $articlesModel = new Admin_Model_GalleriesPhotosModel();
