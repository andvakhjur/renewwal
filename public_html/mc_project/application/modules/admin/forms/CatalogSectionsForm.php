...
class Admin_Form_CatalogSectionsForm extends Mc_Form
{
    ...
    public function init()
    {
        ...
        //--------------------------------------------------------------------//
        $elementName = 'img';
        $articlesModel = new Admin_Model_CatalogSectionsModel();
        ...
        $this->groups[$groupName][$elementName]->addValidator(new Mc_Validate_ArticleExists(array(
            'modelName' => 'Admin_Model_CatalogSectionsModel',
            'colName' => $elementName,
    ...
    public function mapForm()
    {
        ...
        if(empty($return['url']) && $this->getElement('url')) {
            $catalogSections = new Admin_Model_CatalogSectionsModel();
