...
class Admin_Form_CatalogProductsSizesForm extends Mc_Form
{
    ...
    public function mapForm()
    {
        ...
        if(empty($return['url']) && $this->getElement('url')) {
            $catalogProductsSizes = new Admin_Model_CatalogProductsSizesModel();
            $return['url'] = $catalogProductsSizes->getUrlName($return['title']);
