...
class Admin_BannersArticlesController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_BannersArticlesModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_BannersArticlesModel::getCrumb());
    }
