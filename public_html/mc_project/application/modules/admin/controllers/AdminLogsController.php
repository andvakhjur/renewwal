...
class Admin_AdminLogsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_AdminLogsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_AdminLogsModel::getCrumb());
    }
    ...
    public function editAction()
    {
        ...
        // крошки
        $userModel = new Admin_Model_AdminUsersModel();
        $user = $userModel->getArticle($article['user_id']);
        $this->_breadcrumbs->addCrumb(array(
            'label' => $user['fio'],
        ));
