...
class Admin_CatalogProductsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogProductsModel();
        ...
        if ($this->getRequest()->isPost()) {
            if (sizeof($this->_getParam('cancel')) == '0') {
                if ($form->isValid($this->_getAllParams())) {// save the content item
                    $this->_articlesModel->addArticle($form->mapForm(), array(
                        'form' => $form,
                    ));
    ...
    public function editAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (sizeof($this->_getParam('cancel')) == '0') {
                if ($form->isValid($this->_getAllParams())) {// save the content item
                    $this->_articlesModel->editArticle($form->mapForm(), $id, array(
                        'form' => $form,
                    ));
