...
class Admin_NewsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_NewsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_NewsModel::getCrumb());
    }
