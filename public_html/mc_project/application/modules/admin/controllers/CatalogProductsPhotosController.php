...
class Admin_CatalogProductsPhotosController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogProductsPhotosModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogProductsPhotosModel::getCrumb());
    }
    ...
    public function editAction()
    {
        ...
        // крошки
        $this->_breadcrumbs->addCrumb(array(
            "label" => "{$article['img']} ({$article['title']})",
        ));
