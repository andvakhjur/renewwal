...
class Admin_CatalogProductsAlsoBuyController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogProductsAlsoBuyModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogProductsAlsoBuyModel::getCrumb());
    }
    ...
    public function editAction()
    {
        ...
        $alsoBuy = $productsModel->getArticle($article['also_buy_id']);
        $this->_breadcrumbs->addCrumb(array(
            "label" => "{$product['title']} ({$alsoBuy['title']})",
        ));
