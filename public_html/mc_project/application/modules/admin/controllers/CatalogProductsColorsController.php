...
class Admin_CatalogProductsColorsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogProductsColorsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogSectionsModel::getCrumb());
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogCategoriesModel::getCrumb());
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogProductsModel::getCrumb());
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogProductsColorsModel::getCrumb());
    }
    ...
    public function indexAction()
    {
        ...
        if(!empty($this->_filterValues['prod_id'])) {
    ...
    public function editAction()
    {
        ...
        $product = $productsModel->getArticle($article['prod_id']);
        $colorsModel = new Admin_Model_CatalogColorsModel();
        $color = $colorsModel->getArticle($article['color_id']);
        $this->_breadcrumbs->addCrumb(array(
            "label" => "{$product['title']} ({$color['title']})",
        ));
    ...
    public function ajaxUploadAction()
    {
        ...
        //---добавление записи--------------------------------------------------
        $catalogProductsModel = new Admin_Model_CatalogProductsModel();
        $catalogProductsArticle = $catalogProductsModel->getArticle($this->_filterValues['prod_id']);
        
        $order = $this->_articlesModel->getNextOrder(array(
            'where' => "`prod_id` = '{$catalogProductsArticle['id']}'",
        ));
        $this->_articlesModel->addArticle(array(
            'order' => $order,
            'title' => '',
            'img' => basename($value),
            'prod_id' => $catalogProductsArticle['id'],
            'cat_id' => $catalogProductsArticle['cat_id'],
            'sect_id' => $catalogProductsArticle['sect_id'],
        ));
        //---добавление записи--------------------------------------------------
