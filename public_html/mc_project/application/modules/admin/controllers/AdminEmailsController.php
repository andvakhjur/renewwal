...
class Admin_AdminEmailsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_AdminEmailsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_AdminEmailsModel::getCrumb());
    }
