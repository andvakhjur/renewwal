...
class Admin_CatalogProductsCommentsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogProductsCommentsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogProductsCommentsModel::getCrumb());
    }
    ...
    public function editAction()
    {
        ...
        $datetime = new Zend_Date($article['datetime']);
        $this->_breadcrumbs->addCrumb(array(
            "label" => "{$product['title']} ({$datetime->toString('yyyy-MM-dd')})",
        ));
