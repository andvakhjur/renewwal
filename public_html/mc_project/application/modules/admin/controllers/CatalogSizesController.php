...
class Admin_CatalogSizesController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogSizesModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogSizesModel::getCrumb());
    }
