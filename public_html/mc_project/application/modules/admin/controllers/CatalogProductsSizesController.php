...
class Admin_CatalogProductsSizesController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogProductsSizesModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogProductsSizesModel::getCrumb());
    }
    ...
    public function editAction()
    {
        ...
        $sizesModel = new Admin_Model_CatalogSizesModel();
        $size = $sizesModel->getArticle($article['size_id']);
        $this->_breadcrumbs->addCrumb(array(
            "label" => "{$product['title']} ({$size['title']})",
        ));
