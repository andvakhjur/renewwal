...
class Admin_AdminMetaController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_AdminMetaModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_AdminMetaModel::getCrumb());
    }
