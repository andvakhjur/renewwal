...
class Admin_AdminExampleController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_AdminExampleModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_AdminExampleModel::getCrumb());
    }
