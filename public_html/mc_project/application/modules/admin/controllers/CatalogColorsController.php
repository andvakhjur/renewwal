...
class Admin_CatalogColorsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogColorsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogColorsModel::getCrumb());
    }
