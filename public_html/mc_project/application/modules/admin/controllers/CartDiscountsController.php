...
class Admin_CartDiscountsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CartDiscountsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CartDiscountsModel::getCrumb());
    }
    ...
    public function editAction()
    {
        ...
        // крошки
        $this->_breadcrumbs->addCrumb(array(
            'label' => "{$article['summ_bottom']} - {$article['summ_top']}",
        ));
