...
class Admin_GalleriesPhotosController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_GalleriesPhotosModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_GalleriesPhotosModel::getCrumb());
    }
    ...
    public function indexAction()
    {
        ...
        if(!empty($this->_filterValues['par_id'])) {
    ...
    public function ajaxUploadAction()
    {
        ...
        //---добавление записи--------------------------------------------------
        $galleryArticlesModel = new Admin_Model_GalleriesArticlesModel();
        $galleryArticlesArticle = $galleryArticlesModel->getArticle($this->_filterValues['par_id']);
        
        $order = $this->_articlesModel->getNextOrder(array(
            'where' => "`par_id` = '{$galleryArticlesArticle['id']}'",
        ));
        $this->_articlesModel->addArticle(array(
            'order' => $order,
            'title' => '',
            'img' => basename($value),
            'par_id' => $galleryArticlesArticle['id'],
        ));
        //---добавление записи--------------------------------------------------
