...
class Admin_CatalogBrandsController extends Mc_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_articlesModel = new Admin_Model_CatalogBrandsModel();
        ...
        $this->_breadcrumbs->addCrumb(Admin_Model_CatalogBrandsModel::getCrumb());
    }
